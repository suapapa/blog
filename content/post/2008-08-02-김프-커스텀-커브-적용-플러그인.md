...
<img loading="lazy" src="https://homin.dev/asset/blog/2008/08/python_fu_apply_curve_memu.png" alt="python_fu_apply_curve_memu.png" class="imageframe" width="420" height="370" /> 

아래가 실행화면. Curve file에서 적용할 커브 파일을 고르고 (포토샾, 김프 커브파일을 구분없이 사용하면 됩니다)? 확인을 누르시면 사진에 커브가 적용됩니다.

<img loading="lazy" src="https://homin.dev/asset/blog/2008/08/python_fu_apply_curve_dialog.png" alt="python_fu_apply_curve_dialog.png" class="imageframe" width="420" height="370" /> 
